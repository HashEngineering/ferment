...
%ignore dpp_identity_identity_public_key_contract_bounds_ContractBounds_SingleContract_Body;
%ignore dpp_identity_identity_public_key_contract_bounds_ContractBounds_SingleContractDocumentType_Body;
