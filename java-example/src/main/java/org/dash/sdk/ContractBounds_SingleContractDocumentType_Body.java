...
public class ContractBounds_SingleContractDocumentType_Body {
  ...
  public void set_0(Identifier value) {
    exampleJNI.ContractBounds_SingleContractDocumentType_Body__0_set(swigCPtr, this, Identifier.getCPtr(value), value);
  }

  public Identifier get_0() {
    long cPtr = exampleJNI.ContractBounds_SingleContractDocumentType_Body__0_get(swigCPtr, this);
    return (cPtr == 0) ? null : new Identifier(cPtr, false);
  }

  public void set_1(String value) {
    exampleJNI.ContractBounds_SingleContractDocumentType_Body__1_set(swigCPtr, this, value);
  }

  public String get_1() {
    return exampleJNI.ContractBounds_SingleContractDocumentType_Body__1_get(swigCPtr, this);
  }
